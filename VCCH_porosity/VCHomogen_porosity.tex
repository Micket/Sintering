...
\begin{alignat}{2}
    \ta v &= \bar{\ta v} + \bar{\ts{h}} \cdot [\ta{x}-\bar{\ta{x}}] + \ta v^\fluct, &\quad& \ta v^\fluct\in\set{U}_\rve^\fluct
\label{eq29a} \\
...
\begin{align}
d_\rve(\bar{\ts\tau}\cdot \ta n, \ta v^\fluct) = 0\quad \forall\ta v^\fluct\in\set{U}_\rve^\fluct,\;\bar{\ts\tau}\in\set{R}^{3\times3}.
\label{eq:dtauu0}
\end{align}
...
\begin{align}
d_\rve(\ta t,\delta\ta v^\fluct) = d_\rve(\ta t^\fluct, \delta\ta v^\fluct)\quad \forall\delta\ta v^\fluct \in\set{U}_\rve^\fluct
\end{align}
...
For \emph{given} values $\bar{\ta v}$, $\bar{\ts{h}}$, and $\bar{p}$, that represent the macroscale fields (and which solve the macroscale problem), find the subscale fluctuations $(\ta v^\fluct,p^\fluct,\ta{t}^\fluct)\in\set{U}_\rve^\fluct\times\set{P}_\rve^\fluct\times\set{T}_\rve^\fluct$ that solve the system
%----------------------------------------------------------------------------
...
\begin{alignat}{3}
    ...
    &\quad& \forall \delta\ta v^\fluct &&\in \set{U}_\rve^\fluct
\label{eq31a} \\
...
\begin{subequations}
\begin{align}
 \set{U}_\rve^{\prime\fluct}(\ta v^\macro, p^\macro) &\defeq \{ \set{U}_\rve^\fluct \ni \dif\ta v^\fluct = (\ta v^\fluct)'\{\ta v^\macro, p^\macro; \dif\ta v^\macro, \dif p^\macro\}, \dif\ta v^\macro \in \set{U}_\rve^{\macro,0},  \dif p^\macro \in \set{P}_\rve^{\macro} \}
\\
 \set{P}_\rve^{\prime\fluct}(\ta v^\macro, p^\macro) &\defeq \{ \set{P}_\rve^\fluct \ni \dif p^\fluct = (p^\fluct)'\{\ta v^\macro, p^\macro; \dif\ta v^\macro, \dif p^\macro\}, \dif\ta v^\macro \in \set{U}_\rve^{\macro,0},  \dif p^\macro \in \set{P}_\rve^{\macro} \}
\end{align}
\end{subequations}
whereby $\dif\ta v^\fluct\in \set{U}_\rve^{\prime\fluct}$ and $\dif p^\fluct\in \set{P}_\rve^{\prime\fluct}$ represent sensitivity fields (or directional derivatives) for given changes $\dif\ta v^\macro \in\set{U}_\rve^{\macro,0}$ and $\dif p^\macro \in\set{P}_\rve^{\macro,0}$ of the macroscale fields within each RVE.
...
\begin{alignat}{3}
    ...
    &\quad& \forall \dif\ta v^\fluct &&\in \set{U}_\rve^{\prime\fluct}(\ta v^\macro, p^\macro)
...
\end{align}
for any $\dif\ta v^\fluct \in \set{U}_\rve^{\prime\fluct}(\ta v^\macro, p^\macro)$ (by definition of $(\ta v^\fluct)'\{\ta v^\macro, p^\macro; \dif\ta v^\macro, \dif p^\macro\}$).
Now choosing $\delta\ta t^\fluct = \ta t^\fluct$ in \cref{eq:d_macro_sens}, we obtain 
\begin{align}
 d_\rve(\ta t^\fluct, \dif\ta v^\fluct) = 0\quad \forall\dif\ta v^\fluct\in\set{U}_\rve^{\prime\fluct}(\ta v^\macro, p^\macro) \subseteq \set{U}_\rve^\fluct
\label{eq:d_macro_sens2}
\end{align}
Finally, upon choosing $\delta\ta v^\fluct = \dif\ta v^\fluct \in \set{U}_\rve^{\prime\fluct} \subseteq \set{U}_\rve^\fluct$ in \cref{eq31a} and 
...
\end{subequations}
%----------------------------------------------------------------------------
are identical to ($\ta v^\fluct,p^\fluct,\ta{t}^\fluct)\in\set{U}_\rve^\fluct\times\set{P}_\rve^\fluct\times\set{T}_\rve^\fluct$ that solve the system \cref{eq31}.
...
\begin{align}
 ...
 & \check{\ts h}, \delta\check{\ts h} &\in \set{R}^{3\times 3}, & \ta v^\fluct, \delta\ta v^\fluct &\in \set{U}_\rve^\fluct
\\
...
For given values $\bar{\ts d}_\dev, \bar{p}$, find the subscale fields $(\ta v^\fluct,p,\bar{e})\in\set{U}_\rve^{\Dirichlet,\fluct}\times\set{P}_\rve\times\set{R}$ that solve the system
%----------------------------------------------------------------------------
...
\begin{alignat}{3}
    ...
    &\quad& \forall \delta\ta v^\fluct &&\in \set{U}_\rve^{\Dirichlet,\fluct}
\label{eq64a} \\
...
For given values $\bar{\ts d}_\dev, \bar{p}$, find the subscale fields $\ta v,p,\bar{\ts\sigma}_\dev\in\set{U}_\rve\times\set{P}_\rve\times\set{R}^{3\times 3}_\dev$ that solve the system
%----------------------------------------------------------------------------
