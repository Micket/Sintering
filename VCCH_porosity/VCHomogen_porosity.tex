...
\end{align}
which can be split into deviatoric and volumetric parts;
\begin{align}
  \frac{1}{\volume} \Big[\int_{\Gamma_\rve} \ta t \cdot [\ta x-\bar{\ta x}] \dif S + \int_{\partial\Gamma_\rve^\pore} \hat{\ta t} \cdot [\ta x - \bar{\ta x}]\dif C \Big]
 \label{eq:derived_macro_a2}
\end{align}
\todo{??}
...
%----------------------------------------------------------------------------------------------------------------
\begin{align}
    \bar{\ts{\sigma}}_\dev \defeq \frac{1}{\volume}\Big[\int_{\Gamma_\rve} \ta t \outerp[\ta x-\bar{\ta x}] \dif S + \int_{\partial\Gamma_\rve^\pore} \hat{\ta t}\outerp[\ta x - \bar{\ta x}] \dif C \Big] \dprod \tf I_\dev, \, \quad
