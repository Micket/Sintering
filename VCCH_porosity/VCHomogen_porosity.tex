...
\begin{multline}
  \frac{|\Omega_\rve|}{|\Omega_\rve^\particle|}\homgen{ \hat{e}(p) - \ta u^\fluct\cdot\diff} 
          %= \frac{|\Omega_\rve|}{|\Omega_\rve^\particle|}\homgen{ \bar{e}} = \bar{e}
...
\\
          = \frac{|\Omega_\rve|}{|\Omega_\rve^\particle|}[d_\rve(\ta n, \ta u) - \shomgen{\ta u\cdot\ta n}-\homgen{\ta u^\fluct\cdot\diff}]
