...
\begin{figure}[H]
 \centering
 PLACEHOLDER
 %\includegraphics[height=0.4\linewidth]{figures/rve_3d}
 %\includegraphics[height=0.4\linewidth]{figures/rve_3d_half}
...
\begin{figure}[H]
 \centering
 PLACEHOLDER
 %\includegraphics[width=0.4\linewidth]{figures/rve_3d_dirichlet}
 %\includegraphics[width=0.4\linewidth]{figures/rve_3d_periodic}
 %\includegraphics[width=0.4\linewidth]{figures/rve_3d_neumann}
 \caption{3D RVE subject to pure shear}
