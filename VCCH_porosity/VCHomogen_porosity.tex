...
\maketitle
\begin{abstract}
In this paper the Variationally Consistent Homogenization (VCH) of a mixed velocity-pressure formulation with micropores and surface tension is developed to model the problem of sintering.
