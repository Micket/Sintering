...
\usetheme[titlepagelogo=Avancez_black.pdf]{chalmers}
...
\onslide<2-> Some things for free
 \begin{enumerate}
...
\begin{center}
\movie[height=6cm,width=6cm,poster]{}{RVE_Fixed_Boundaries.mpeg}

\movie[externalviewer]{RVE with fixed boundaries}{RVE_Fixed_Boundaries.mpeg}
%\movie[height=6cm,width=6cm,poster]{RVE with sheared boundaries}{RVE_Sheared_Boundaries.mpeg}
%\movie[height=6cm,width=6cm,poster]{Multiscale sintering}{Sintering_5x5.mpeg}
\end{center}
\end{frame}
...
\begin{frame}
 \frametitle{Numerical results}
\begin{center}
\movie[height=6cm,width=6cm,poster]{}{RVE_Sheared_Boundaries.mpeg}
...
\begin{frame}
 \frametitle{Numerical results}
\begin{center}
\movie[height=6cm,width=9.7cm,poster]{}{Sintering_5x5.mpeg}
