...
Selected references are \cite{geers_multi-scale_2010,larsson_computational_2011,temizer_optimality_2013}.
In this regard, how to accommodate coalescence of \todo{?}????????????? and failure presents a special challenge, e.g.\ \cite{coenen_multi-scale_2012}. A quite general framework based on ``weakly periodicity'' was proposed in ???. How to incorporate interfaces and thing membranes are discussed in \cite{mcbride_micro--macro_2012, larsson_stress-resultant_2013}.
