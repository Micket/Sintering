...
\end{align}
where $\tf I_\dev$ is the deviatoric fourth order identity tensor such that the isotropic part of $\bar{\tf E}$ could be expressed as
\begin{align}
 \bar{\tf E}_{\mathrm{iso}} = 2 \bar{G} \tf I_\dev
\end{align}
in standard fashion.
