...
% \end{align} 
We can rewrite the sets
\begin{align}
\{ \ts H \cdot [\ta x - \bar{\ta x}] \,|\quad \ts H \in \set{R}^{3\times 3}\} &= \{ \ts s \,|\quad \}
\\
\{ \ta u \,|\quad \ta u \in \set R^3\} &= \{ \frac{1}{|\Gamma_\rve|} \int_{\Gamma_\rve} \ta v \dif S \,|\quad \ta v \in [H^1(\Omega_\rve)]^3 \}
\\
\{ p \,|\quad p\in \set{R}\} &= \{ \frac{1}{\volume} \int_{\Omega_\rve} q \dif V \,|\quad q \in L_2(\Omega_\rve) \}
\\
\{ \ts \tau \cdot \ta n \,|\quad \ts\tau \in \set{R}^{3\times 3}\} &= \{ \,|\quad \}
\end{align}
and it follows that
...
\begin{align}
\set{U}_\rve &= \set{U}_\rve^\fluct \cup \{ \ts H \cdot [\ta x - \bar{\ta x}] \,|\quad \ts H \in \set{R}^{3\times 3}\}  \cup \{ \ta u \,|\quad \ta u = \set R^3\}
\\
\set{P}_\rve &= \set{P}_\rve^\fluct \cup \{ p \,|\quad p\in \set{R}\}
\\
\set{T}_\rve &= \set{T}_\rve^\fluct \cup \{ \ts \tau \cdot \ta n \,|\quad \ts\tau \in \set{R}^{3\times 3}\}
\end{align}
and that
\begin{align}
\{\ta 0\} &= \set{U}_\rve^\fluct \cap \{ \ts H \cdot [\ta x - \bar{\ta x}] \,|\quad \ts H \in \set{R}^{3\times 3}\}
\\
\{\ta 0\} &= \set{U}_\rve^\fluct \cap \{ \ta u \,|\quad \ta u = \set R^3\}
\\
\{\ta 0\} &= \{ \ts H \cdot [\ta x - \bar{\ta x}] \,|\quad \ts H \in \set{R}^{3\times 3}\} \cap \{ \ta u \,|\quad \ta u = \set R^3\}
\\
\{0\} &= \set{P}_\rve^\fluct \cap \{ p \,|\quad p\in \set{R}\}
\\
