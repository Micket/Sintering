...
%\end{equation}
%%----------------------------------------------------------------------------
It is readily seen that the system in \cref{eq84} is precisely that of \cref{eq51}, and we may parameterize its solution as
%----------------------------------------------------------------------------------------------------------------
\begin{equation}
...
\end{equation}
%----------------------------------------------------------------------------------------------------------------------
At the stationary point, we use the result in \cref{eq84}$_3$ to conclude that
%----------------------------------------------------------------------------------------------------------------
\begin{equation}
...
\end{equation}
%----------------------------------------------------------------------------------------------------------------------
\todo{I don't agree with this.}
In order to obtain this result, all the relations in \cref{eq84} defining the stationary point were used, whereby sensitivities were used as test functions.
For example, we adopted $\delta\ta{u}=\dif \ta{u}\{\bar{\ts\epsilon}_\dev,\bar{p}\}=(\ta{u})'_{\epsilon_d}\{\bar{\ts\epsilon}_\dev,\bar{p};\dif\bar{\ts\epsilon}_\dev\}+(\ta{u})'_{p}\{\bar{\ts\epsilon}_\dev,\bar{p};\dif \bar{p}\}$.
\textbf{Appendix??}
