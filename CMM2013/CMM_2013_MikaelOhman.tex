...
In the presence of surface tension and pores, as shown in \figref{fig:initial_rve}, the suitable RVE-potential can be expressed as an implicit function of the macroscopic control variables $\bar{\ts d}_\dev$ and $\bar{p}$:
% TODO
...
The additional (traction) field $\ta t$ is the Lagrange multiplier associated with the jump, $\jump{\bullet} \defeq \bullet^+ - \bullet^-$, of the velocity fluctuations on the boundary of the RVE.
