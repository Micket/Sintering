...
% FREDRIK: Hur blir det med volymsintegralerna här? Integrerar vi över $\Omega_\Box$ eller ``$\Omega_\Box^{\mathrm{pore}}$''.
% Hur blir det vid omskrivning till randintegraler? Blir det så trevligt att det tar ut sig mot $l_\Box^\internal$ kanske?
\begin{multline}
  \frac{1}{|\Omega_\Box|}
