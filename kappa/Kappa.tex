...
As an alternative, the procedure in \refpaper{B} represents pure algebraic manipulations to rewrite \cref{eq:prototype_macro_A} in order to enable to transition into the macroscopically incompressible limit.
