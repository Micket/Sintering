...
\begin{itemize}
  ...
  \begin{equation*}
   \ta v = \overbrace{\underbrace{\bar{\ts d}_\dev}_{\text{Prescribed}} \cdot \underbrace{[\ta x - \bar{\ta x}]}_{\text{Weights}}}^{\ta v^\macro_\dev} + 
           \overbrace{\underbrace{\bar{e}}_{\text{Unknown}} \underbrace{\frac13 [\ta x - \bar{\ta x}]}_{\text{Weight}}}^{\ta v^\macro_\vol}  \text{ on } \Gamma_\Box
  \end{equation*}
  ...
  \item Better yet, stress is obtained trivially as the reaction-forces associated with the prescribed DOFs $\bar{\ts d}_\dev$!
