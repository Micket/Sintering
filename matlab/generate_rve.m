...
eltype = {'Tr21Stokes','Tr21Stokes','Line2SurfaceTension','Line2SurfaceTension','Line2Boundary','Line2Boundary','Line2Boundary','Line2Boundary','Line2Boundary','Line2Boundary','Line2Boundary','Line2Boundary'};
a = acos(0.5/radius);
...
fprintf(fid, ['%s\n',...
    ...
    'StokesFlow nsteps 2000 lstype 3 smtype 7 nmodules 1 deltaT 0.001 nonlinform 2 rtolv 1e-6, rtold 1e6\n',...
    'vtkxml tstep_all domain_all primvars 2 4 5 cellvars 1 46 stype 0\n',...
    'domain 2dIncompFlow\n',...
    'OutputManager tstep_all dofman_all element_all\n',...
    'ndofman 0 nelem 0 ncrosssect 12 nmat 5 nbc 2 nic 0 nltf 1 topology particletopology\n'], basename);
...
fprintf(fid, ['NewtonianFluid 1 d 1 mu 1\n',...
    ...
    ...%'MixedGradientPressureDirichlet 1 loadTimeFunction 1 devgradient 3 0.0 0.0 0.0 pressure 0.0 cCoord 2 0.0 0.0 defaultDofs 2 7 8\n',...
    'MixedGradientPressureNeumann 1 loadTimeFunction 1 devgradient 3 0.0 0.0 0.0 pressure 0.0\n',...
    'BoundaryCondition 2 loadTimeFunction 1 d 0.0 defaultDofs 2 7 8\n',...
