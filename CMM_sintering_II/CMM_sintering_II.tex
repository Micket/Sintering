...
%\documentclass[10pt,5p]{elsarticle} % Seems to be closer to the final articles
...
\address{Chalmers University of Technology, H\"orsalsv\"agen 7B, G\"oteborg}
...
In the very simplest case, the RVE consists of one single ``unit cell'' containing a single contiguous pore.
...
\begin{figure}[thpb!]
    \centering
    \subfloat[$t = 0$]{\includegraphics[scale=0.12]{figures/evolve_shear_a}\label{fig:evolve_shear_a}}
    \hspace{1em}
    \subfloat[$t = 0.45\; t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_shear_b}\label{fig:evolve_shear_b}}
    %\hspace{1em}
    \subfloat[$t = 0.65\; t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_shear_c}\label{fig:evolve_shear_c}}
    %\hspace{1em}
    \subfloat[$t = t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_shear_d}\label{fig:evolve_shear_d}}
...
\begin{figure}[thpb!]
  ...
  \begin{axis}[ yticklabel style={ /pgf/number format/fixed, /pgf/number format/precision=2 },
                ...
                height=0.15\textheight, width=0.8\linewidth, xmin=0, xmax=1, ymax=0.175, ymin=-0.015,
...
\begin{figure}[thpb!]
    \centering
    \subfloat[$t = 0$]{\includegraphics[scale=0.12]{figures/evolve_free_a}\label{fig:evolve_free_a}}
    \hspace{1em}
    \subfloat[$t = 0.45\; t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_free_b}\label{fig:evolve_free_b}}
    \hspace{1em}
    \subfloat[$t = 0.65\; t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_free_c}\label{fig:evolve_free_c}}
    \hspace{1em}
    \subfloat[$t = t_{\mathrm{end}}$]{\includegraphics[scale=0.12]{figures/evolve_free_d}\label{fig:evolve_free_d}}
...
This procedure is similar to previous work, \cite{Ohman2012a}, with the exception that both the velocity and pressure field are now divided into smooth macroscopic parts and subscale fluctuations.
