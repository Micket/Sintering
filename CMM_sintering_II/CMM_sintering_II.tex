...
In the paper by \textsc{Öhman et al.} \cite{Ohman2011a} the homogenization theory was presented in a format that is restricted to the situation that the macroscale response is compressible.
...
It is, therefore, relevant to first summarize the theory presented in \cite{Ohman2011a}:
...
\begin{figure}[thpb!]
    \centering
    \subfloat[$t = 0$]{\includegraphics[scale=0.14]{figures/evolve_shear_a}\label{fig:evolve_shear_a}}
    \hspace{1em}
    \subfloat[$t = 0.45\; t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_shear_b}\label{fig:evolve_shear_b}}
    %\hspace{1em}
    \subfloat[$t = 0.65\; t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_shear_c}\label{fig:evolve_shear_c}}
    %\hspace{1em}
    \subfloat[$t = t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_shear_d}\label{fig:evolve_shear_d}}
...
\begin{figure}[thpb!]
  ...
  \begin{axis}[ yticklabel style={ /pgf/number format/fixed, /pgf/number format/precision=2 },
                ...
                height=0.2\textheight, width=0.8\textwidth, xmin=0, xmax=1, ymax=0.175, ymin=-0.015,
...
\begin{figure}[thpb!]
    \centering
    \subfloat[$t = 0$]{\includegraphics[scale=0.14]{figures/evolve_free_a}\label{fig:evolve_free_a}}
    \hspace{1em}
    \subfloat[$t = 0.45\; t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_free_b}\label{fig:evolve_free_b}}
    \hspace{1em}
    \subfloat[$t = 0.65\; t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_free_c}\label{fig:evolve_free_c}}
    \hspace{1em}
    \subfloat[$t = t_{\mathrm{end}}$]{\includegraphics[scale=0.14]{figures/evolve_free_d}\label{fig:evolve_free_d}}
