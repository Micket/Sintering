...
%\dif\left[a_\Box(\ta{v}; \hat{\ta{v}}^{\macro(ij)}_\dev\right]
%\label{eq218}
%\end{equation}
%%------------------------------------------------------------------------------------
%---------------------------------------------------------------------------------------
\begin{align}
    ...
    & = 
%    \dif \left[\left\langle \ts{\sigma} \dprod \hat{\ts{d}}^{\macro(ij)}_\dev \right\rangle_\Box\right] =
%    \dif \left[a_\Box(\ta{v}; \hat{\ta{v}}^{\macro(ij)}_\dev)\right]
%    \nonumber \\
    \left\langle \dif\ts{\sigma}_\dev\dprod\left(\bee ij\right)^\sym\right\rangle_\Box=
    \left\langle \dif\ts{\sigma}_\dev\dprod\hat{\ts{d}}^{\macro(ij)}_\dev\right\rangle_\Box=
